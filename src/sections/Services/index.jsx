    ...
    return (
        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <p><span class="highlight">En Moonlight Design</span> somos expertos
            ...
            <div class="card">
                ...
                <p><span class="highlight">En Moonlight Design</span> elevamos tu
                ...
                <p>Conectamos con tus clientes, diseñamos estrategias que transmiten
                    ...
                    con <span class="highlight">Moonlight Design</span>.</p>
            </div>

            <div class="card">
                <h2>DISEÑO WEB</h2>
                <p>Nuestro servicio de <span class="highlight">diseño web</span> fusiona tus
                ...
                <p>Garantizamos potenciar la identidad de tu marca y la mejor experiencia de
                    usuario. En <span class="highlight">Moonlight Design</span> nos caracterizamos
                    por la optimización y calidad. Haz que tus productos brillen en el mundo
                    digital, <span class="highlight">contáctanos</span>.</p>
            </div>
